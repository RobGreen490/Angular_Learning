Step-03{
    ...
    File application.properties{
        ...
        Line 5: added app name to display within the info environment
        Line 6: added description to display within the info environment
        line 7: added version to display within the info environment
    }
}
