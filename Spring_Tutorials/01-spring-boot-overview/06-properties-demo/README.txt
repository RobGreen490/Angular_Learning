step-06{
    File FunRestController.java{
        Line 13-16: Creating property injected variables
        Line 19-22: Added an endpoint accessor for "teaminfo" that returns the coach and team names.
    }
    File application.properties{
        Line 13-14: Defined two properties that will be injected into the "teaminfo".
        Line 19: Changed port.
        Line 25: Added a pre-fix for all paths on the website.
    }
    File pom.xml{
        Line 45-48: uncommented out the actuatory dependency.
    }
}
